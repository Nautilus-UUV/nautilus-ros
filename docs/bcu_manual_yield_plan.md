...
- `src/py_pkg/py_pkg/control/bcu_safe_stop_burst.py` — new `BcuSafeStopBurst` pure class.
- `src/py_pkg/py_pkg/control/bcu_node.py` — `MANUAL_HOLD_S = 1.5`; the burst counter
