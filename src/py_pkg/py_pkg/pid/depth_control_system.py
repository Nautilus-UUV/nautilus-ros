...
gauge Pa) and outputs a bladder flow ratio q in 1/s. Sign
...
in ``bcu_node``, not here. Note the sign flip there: on the BCU bus
...
class DepthControlSystem:
    ...
    step. ``bcu_node`` ticks it at 10 Hz.
    """
    ...
    def __init__(self, config: DepthSpec) -> None:
        ...
        # bcu_node's control_loop gates calc_acc on its own
