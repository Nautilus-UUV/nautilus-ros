...
is the pure decision: pass the pump command through with valve 1 open,
or — below the deep threshold with descent intent — force the pump off
and open valve 2 to vent passively. Sign convention: Z-positive-down,
gauge pressure, so `current_pressure_pa > threshold` means "below the
threshold depth", and `q > 0` is a sink intent.
"""
...
class TestShallow:
    ...
    def test_descend_active_pump_uses_valve1(self):
        ...
        rpm, v1, v2 = select_pump_and_valves(SHALLOW, 0.5, -1500, THRESHOLD)
    ...
    def test_idle_pump_closes_both(self):
        rpm, v1, v2 = select_pump_and_valves(SHALLOW, 0.0, 0, THRESHOLD)
    ...
    def test_descend_intent_with_deadbanded_pump_keeps_both_closed(self):
        ...
        rpm, v1, v2 = select_pump_and_valves(SHALLOW, 0.001, 0, THRESHOLD)
        assert (rpm, v1, v2) == (0, 0, 0)
...
class TestDeep:
    ...
    def test_descend_overrides_pump_to_zero_and_opens_valve2(self):
        ...
        rpm, v1, v2 = select_pump_and_valves(DEEP, 0.5, -3000, THRESHOLD)
    ...
    def test_descend_with_idle_pump_still_opens_valve2(self):
        ...
        # below the threshold.
        rpm, v1, v2 = select_pump_and_valves(DEEP, 0.001, 0, THRESHOLD)
        assert (rpm, v1, v2) == (0, 0, 1)

    def test_ascend_active_pump_uses_valve1(self):
        # No descent intent → valve 2 stays closed; valve 1 carries flow.
        rpm, v1, v2 = select_pump_and_valves(DEEP, -0.5, 1500, THRESHOLD)
        assert (rpm, v1, v2) == (1500, 1, 0)

    def test_quiescent_closes_both(self):
        rpm, v1, v2 = select_pump_and_valves(DEEP, 0.0, 0, THRESHOLD)
        assert (rpm, v1, v2) == (0, 0, 0)
...
class TestZeroIntentSign:
    ...
    def test_deep_with_q_zero_does_not_vent(self):
        rpm, v1, v2 = select_pump_and_valves(DEEP, 0.0, 1500, THRESHOLD)
        assert (rpm, v1, v2) == (1500, 1, 0)
